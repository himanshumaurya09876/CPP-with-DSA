...
Given a string of digits, where every digit represents a letter (1- a, 2-b, 26-z). Print all the words that we can generate from that string. For example: 123 - abc, lc, aw. 456 - def. -> codeOfStrings.cpp
